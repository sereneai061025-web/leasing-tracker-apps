# leasing-tracker-apps

A shared F&B licence tracking tool for compliance teams to log, monitor, and renew licences across multiple authorities — replacing spreadsheets and chat with one live operational dashboard.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "296506820+sereneai061025-web@users.noreply.github.com"
  git config user.name "sereneai061025-web"
  ```
